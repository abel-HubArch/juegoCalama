...
var sumar = function(){
    ...
    var precioTotal = 110 * sumaDelLosModelos;
...
var getData = function(){
    ...
    if(xl <= "0" && l <= "0" && m <= "0" && s <= "0"){
        ...
        window.open(`https://api.whatsapp.com/send?phone=++59162569556&text=*EL%20JUEGO%20DEL%20CALAMAR*%0A%0A*PEDIDO*:%20${cantidad}%0A%0A*TALLAS*:%0A*XL:*%20${xl}%0A*L:*%20${l}%0A*M:*%20${m}%0A*S:*%20${s}%0A%0A*DEPARTAMENTO*:%20${departamento}%0A%0A%0A*PRECIO%20TOTAL*:%20${costoFinal}`, '_blank')
    }
}